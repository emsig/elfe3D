...
The numerical modelling program `elfe3D` calculates forward responses for frequency-domain three-dimensional (3D) controlled-source electromagnetic surveys in geophysics. 
